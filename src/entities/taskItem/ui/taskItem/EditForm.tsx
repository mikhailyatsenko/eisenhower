...
import { Task } from '@/entities/taskMatrix/@x/task'; //@x notation is used to cross-imports between slices (see https://feature-sliced.design/docs/guides/examples/types)

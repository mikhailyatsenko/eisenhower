...
export const TaskSourceTabs: React.FC<TaskSourceTabsProps> = ({
  ...
  return (
    <div
      role="button"
      className="fixed top-0 left-1/2 z-[20] flex h-6 w-32 -translate-x-1/2 cursor-pointer rounded-b-md bg-gray-300/50 font-medium select-none dark:bg-gray-300/20"
